...
public class Btn_Level04 : Btn_Level
{
    [Header("Btn Level04")]
    private const string CompletedStarsKey = "CompletedStars04";
    private static Btn_Level04 _instance;
    public static Btn_Level04 Instance => _instance;
    protected override void Awake()
    {
        base.Awake();
        if (_instance != null) Debug.Log("Just only 1 Btn_Level04 allow exsist");
        _instance = this;
    }
    ...
    {
        PlayerPrefs.SetInt("SaveStars04", numStars);
        PlayerPrefs.Save();
    }
}
