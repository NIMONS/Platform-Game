...
public class Btn_Level03 : Btn_Level
{
    [Header("Btn Level03")]
    private const string CompletedStarsKey = "CompletedStars03";
    private static Btn_Level03 _instance;
    public static Btn_Level03 Instance => _instance;
    protected override void Awake()
    {
        base.Awake();
        if (_instance != null) Debug.Log("Just only 1 Btn_Level03 allow exsist");
        _instance = this;
    }
    ...
    {
        PlayerPrefs.SetInt("SaveStars03", numStars);
        PlayerPrefs.Save();
    }
}
